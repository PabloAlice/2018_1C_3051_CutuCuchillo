...
namespace TGC.Group.MyAbstractions
{
    /// <summary>
    ...
    public class Tgc3dSound
    {
        ...
        public Tgc3dSound(string soundPath, TGCVector3 position, Device device, BufferDescription bufferDescription)
        {
            loadSound(soundPath, device, bufferDescription);
            Position = position;
        }
