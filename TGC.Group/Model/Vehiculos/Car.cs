...
namespace TGC.Group.Model.Vehiculos
{
    class Car : Vehicle
    {
        public Car(TGCVector3 posicionInicial, SoundsManager soundsManager) : base(posicionInicial, soundsManager)
        {
            ...
            this.CreateMesh(GlobalConcepts.GetInstance().GetMediaDir() + "meshCreator\\meshes\\Vehiculos\\Auto\\Auto-TgcScene.xml", posicionInicial);
        ...
        override protected void CreateSounds(SoundsManager soundsManager)
        {
            ...
            soundsManager.AddSound(position, 50f, -1000, "Van\\Motor.wav", "Motor", true);
