...
namespace TGC.Group.Model.GameModelStates
{
    class Win : GameModelState
    {
        ...
        public Win(GameModel gameModel, Vehicle car)
        {
            ...
            gameOver.Bitmap = new CustomBitmap(MediaDir + "GUI\\Menu\\you-win.png", D3DDevice.Instance.Device);
